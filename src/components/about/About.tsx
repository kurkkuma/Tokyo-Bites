        ...
        <div className="about">
          <div className="info">
            ...
            <p className="text1">
              ...
              Japanese sushi and other gourmet Asian dishes. We are proud to
              offer fresh and quality ingredients, prepared with the skill of
            ...
            <p className="text2">
              ...
              unique space ideal for relaxing lunches and dinners with friends
              and family.
            </p>
